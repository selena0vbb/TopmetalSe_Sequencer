...
#                script (type 'adc_frame_mem.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adc_frame_mem xil_defaultlib.glbl -o adc_frame_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adc_frame_mem_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/selena/TopmetalSe_Sequencer/TopmetalSe_Sequencer.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key adc_frame_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adc_frame_mem_simv.daidir vcs_lib c.obj)
