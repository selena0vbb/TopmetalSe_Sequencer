...
#
# Script generated by Vivado on Mon Jan 06 15:49:26 PST 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : adc_frame_mem.sh
...
#
# Usage        : adc_frame_mem.sh
#                adc_frame_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adc_frame_mem.sh [-reset_run]
#                adc_frame_mem.sh [-reset_log]
#                adc_frame_mem.sh [-help]
#
...
# script info
echo -e "adc_frame_mem.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adc_frame_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot adc_frame_mem xil_defaultlib.adc_frame_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim adc_frame_mem -key {Behavioral:sim_1:Functional:adc_frame_mem} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/selena/vivado/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb adc_frame_mem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adc_frame_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adc_frame_mem.sh [-help]\n\
Usage: adc_frame_mem.sh [-step]\n\
Usage: adc_frame_mem.sh [-lib_map_path]\n\
Usage: adc_frame_mem.sh [-reset_run]\n\
Usage: adc_frame_mem.sh [-reset_log]\n\
Usage: adc_frame_mem.sh [-keep_index]\n\
Usage: adc_frame_mem.sh [-noclean_files]\n\n\
