...
#
# Script generated by Vivado on Thu Jul 20 13:56:55 PDT 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../TopmetalSe_Sequencer.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../TopmetalSe_Sequencer.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/damic/HDD/TopmetalSe_Sequencer/TopmetalSe_Sequencer.cache/compile_simlib/vcs"
  fi
