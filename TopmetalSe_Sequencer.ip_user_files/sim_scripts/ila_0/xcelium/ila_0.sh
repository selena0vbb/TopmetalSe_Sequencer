...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../TopmetalSe_Sequencer.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../TopmetalSe_Sequencer.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/damic/HDD/TopmetalSe_Sequencer/TopmetalSe_Sequencer.cache/compile_simlib/xcelium"
  fi
